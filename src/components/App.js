    ...
    return (
        <div id="main">
           ...
           <div className="categories">
                ...
                <button className="btn" id="filter-btn-3"  onClick={()=>getFoodItems("breakfast")}
                data-test-id="menu-item-breakfast"
                >Breakfast</button>
                <button className="btn" id="filter-btn-2" onClick={()=>getFoodItems("lunch")}
                data-test-id="menu-item-lunch"
                >Lunch</button>
                <button className="btn" id="filter-btn-1" onClick={()=>getFoodItems("shakes")}
